...
$user_id = $conn->prepare('SELECT * FROM `cadastro` WHERE `id_cad`=:pid AND `type_user` = 1');
$user_id->bindValue(':pid', $_SESSION['login']);
$user_id->execute();
$row_nome = $user_id->fetch();


if($row_nome['type_user'] != 1){
